...
testimonial_author_position: "Co-founder and CPO at Allure TestOps (Qameta)"
...
about_company:
  logo: 'qameta.png'
  heading: 'About Allure TestOps (Qameta)'
  text: |
...
{{< case_study/column >}}
Qameta received Qameta Software Cloud – an architected solution based on the on-prem Qameta Software software – in time. To minimize in-house development, therefore, further maintenance, FivexL used as many ready-to-use components and managed services as possible. Artem Eroshenko said: “By developing infrastructure, FivexL allowed us to focus on our core business: product development, hypothesis testing, feedback collection from real users, and roadmap generation.”  
FivexL engaged in the project two of its AWS Solutions Architects. Firstly, Ivan Razzhivin built an MVP and Serverless API that allowed it to launch environments with a single click. To create and control specific client resources in a cloud provider from the EKS cluster, Crossplane (dynamic resources controller) and ArgoCD were used. As a result, Qameta Software evolved from Kubernetes helm charts to a cloud-based SaaS offering.   
...
<br/>   
[Qameta launched](https://qameta.io/blog/allure-testops-cloud-is-generally-available-to-all-dev-teams/) a fully-fledged solution in July 2022. Many clients waited in line to use the Qameta Software Cloud.   
